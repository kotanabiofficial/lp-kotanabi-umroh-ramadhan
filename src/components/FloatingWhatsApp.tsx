...
const FloatingWhatsApp: React.FC<FloatingWhatsAppProps> = ({
  ...
  return (
    <a
      ...
      className="ctawa fixed bottom-0 inset-x-0 z-50 bg-green-500 text-white font-bold py-4 sm:py-3 px-5 rounded-t-xl sm:rounded-full sm:bottom-6 sm:right-6 sm:left-auto sm:w-auto shadow-[0_-4px_10px_rgba(0,0,0,0.1)] sm:shadow-lg flex justify-center sm:justify-start items-center space-x-2 hover:bg-green-600 transition-all duration-300 sm:transform sm:hover:scale-105"
