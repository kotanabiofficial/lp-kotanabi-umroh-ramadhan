...
const CallToAction: React.FC<CallToActionProps> = ({
  ...
  description = "Program Umroh Itikaf Ramadhan adalah paket yang paling cepat terisi. Amankan seat Anda sekarang juga sebelum kehabisan. Wujudkan bulan Ramadhan penuh berkah dalam hidup Anda.",
  boxTitle = "Dapatkan Informasi Lengkap & Promo Spesial!",
  boxDescription = "Klik tombol di bawah untuk konsultasi gratis dengan tim admin KotaNabi via WhatsApp. Kami siap membantu pendaftaran umroh Anda untuk meraih pahala umroh dengan aman dan nyaman.",
    ...
    <section id="kontak" className="relative py-20 bg-secondary text-white">
      ...
      <div className="relative container mx-auto px-6 text-center">
        ...
        <div className="bg-white/90 text-dark p-8 md:p-12 rounded-lg shadow-2xl max-w-2xl mx-auto">
          <h3 className="text-2xl font-bold mb-6 text-secondary font-serif">{boxTitle}</h3>
          ...
          <a
            ...
            className="ctawa inline-block bg-green-500 hover:bg-green-600 text-white font-bold py-4 px-10 rounded-full text-lg transition duration-300 transform hover:scale-105 shadow-xl"
          >
