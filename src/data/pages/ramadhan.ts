...
export const ramadhanData: LandingPageData = {
  ...
  valueProposition: {
    ...
    features: [
      ...
      { icon: '🍽️', title: 'Sajian Sahur & Buka Puasa', description: 'Manjakan lidah Anda saat sahur dan iftar dengan variasi menu masakan internasional maupun cita rasa nusantara yang lezat, bergizi, dan terjamin kehalalannya setiap hari. Khusus untuk paket bintang 4 & 5.' },
      ...
      { icon: '✅', title: 'Travel Resmi Terpercaya', description: 'Kota Nabi bermitra dengan travel penyelenggara perjalanan ibadah umroh yang telah mengantongi izin resmi dari Kementerian Agama, kami memberikan garansi kepastian keberangkatan demi ketenangan hati Anda.' }
    ]
  },
  problemAgitation: {
  ...
  gallery: {
    title: "Fasilitas dan Momen Perjalanan Jamaah Umroh",
    subtitle: "Lihat lebih dekat kenyamanan yang akan Anda dapatkan dari biro travel umroh rekomendasi KotaNabi.",
    images: [
        ...
        'https://storage.googleapis.com/muslimpergi/uploads/gallery/pict/10510/dokumentasi-umroh-janamadinahwisata_jamaah-umroh.jpeg',
        'https://storage.googleapis.com/muslimpergi/uploads/gallery/pict/10508/dokumentasi-umroh-janamadinahwisata_30-oktober.jpeg',
  ...
  faq: [
    ...
    { question: "Bagaimana prosedur pendaftarannya?", answer: "Cukup hubungi konsultan kami via WhatsApp untuk memilih paket, dan kami akan memandu seluruh proses administrasi pendaftaran hingga keberangkatan." }
  ],
  cta: {
