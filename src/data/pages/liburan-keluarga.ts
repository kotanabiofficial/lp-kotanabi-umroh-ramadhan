...
export const liburanKeluargaData: LandingPageData = {
  ...
  gallery: {
    title: "Momen Kebersamaan di Tanah Suci",
    subtitle: "Lihat kebahagiaan keluarga yang telah mempercayakan perjalanan ibadahnya bersama kami.",
    images: [
  ...
  faq: [
    { question: "Apakah jadwalnya pasti pas liburan sekolah?", answer: "Ya, kami menyusun jadwal keberangkatan khusus di bulan Juni, Juli, Agustus, dan September 2026 untuk menyesuaikan dengan masa liburan sekolah." },
    { question: "Apakah ada diskon untuk anak-anak?", answer: "Terdapat potongan harga khusus untuk anak-anak (usia tertentu) dan bayi (infant). Silakan konsultasikan dengan tim kami untuk detail perhitungannya." },
    { question: "Bagaimana cuaca di bulan Juni-Juli 2026?", answer: "Musim panas di Arab Saudi cukup hangat. Namun, kami mengantisipasi dengan memilih hotel dekat masjid, bus AC dingin, dan jadwal kegiatan yang ramah fisik, terutama untuk anak-anak dan lansia." },
    ...
    { question: "Berapa DP untuk mengamankan kursi?", answer: "Cukup dengan DP ringan, Anda sudah bisa mengamankan kursi untuk keberangkatan 2026. Pelunasan bisa dilakukan bertahap hingga sebulan sebelum keberangkatan." },
  ...
  packages: [
    {
      ...
      waMessage: 'Assalamualaikum, saya tertarik dengan paket *Umroh Easy Juni 2026*.'
    },
    {
      name: 'Umroh Liburan Sekolah 4 Juli 2026 by Namira Travel',
      duration: '9 Hari',
      price: 'Rp26.500.000',
      features: ['Penutup Liburan Berkah', 'Hotel Bintang 4', 'Full Board Menu Indonesia', 'Handling Koper & Dokumen', 'Travel Namira'],
      isPopular: false,
      image: 'https://storage.googleapis.com/muslimpergi/uploads/gallery/pict/10022/mp-mekkah-kaabah.webp',
